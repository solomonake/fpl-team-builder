...
def load_player_data():
    ...
    # Updated path for standalone backend
...
def home():
    """Home endpoint"""
    return jsonify({
        "message": "FPL Team Builder API",
        "version": "1.0.0",
        "endpoints": {
            "/api/best-team": "Generate optimal team",
            "/api/all-players": "Get all players",
            "/api/player/<id>": "Get player details",
            "/api/smart-team": "Generate AI-powered team",
            "/api/form-players": "Get players in form",
            "/api/top-teams": "Get popular team strategies"
        }
    })
